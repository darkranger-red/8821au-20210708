...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 1, 0) || defined(RHEL9))
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 19, 2) || defined(RHEL9))
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 3, 0) && (LINUX_VERSION_CODE < KERNEL_VERSION(6, 9, 0)))
...
check_bss:
	...
	if (rtw_to_roam(padapter) > 0) {
		...
		#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 12, 0)
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 0, 0) || defined(RHEL9))
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 7, 0) || defined(RHEL9))
...
static int cfg80211_rtw_tdls_mgmt(struct wiphy *wiphy,
	...
	u8 *peer,
#endif
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 5, 0) || defined(RHEL9))
	int link_id,
#endif
	u8 action_code,
	u8 dialog_token,
